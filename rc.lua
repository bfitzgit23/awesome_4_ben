...
awful.layout.layouts = {
    ...
    awful.layout.suit.corner.ne,		--13
    awful.layout.suit.corner.sw,		--14
    awful.layout.suit.corner.se,		--15
    lain.layout.centerwork,				--16
    lain.layout.centerwork.horizontal,	--17
    lain.layout.termfair,				--18
    lain.layout.termfair.center,		--19
    lain.layout.cascade,
...
--    awful.key({ altkey }, "p", function() os.execute("screenshot") end),
	...
	awful.key({ modkey }, "p", function () awful.util.spawn( terminal ..  " -e pamix" ) end),
	awful.key({ modkey }, "w", function () awful.util.spawn( terminal ..  "sudo -e wifi-menu" ) end),
	...
	awful.key({ altkey }, "i", function () awful.util.spawn( "insync start" ) end),
	awful.key({ altkey }, "d", function () awful.util.spawn( "dropbox" ) end),
	awful.key({ altkey }, "r", function () awful.util.spawn( "polychromatic-tray-applet" ) end),
	awful.key({ altkey }, "p", function () awful.util.spawn( "/opt/piavpn/bin/pia-client" ) end),
	awful.key({ altkey, "Shift" }, "p", function () awful.util.spawn( "pkill /opt/piavpn/bin/pia-client" ) end),
	...
	awful.key({ modkey }, "t", function () awful.util.spawn( "cawbird" ) end),

	-- Conky HUD
	awful.key({ altkey }, "z", function () awful.util.spawn( "sh /home/msjche/.config/awesome/conky_launch.sh" ) end),
	awful.key({ altkey, "Shift" }, "z", function () awful.util.spawn( "pkill conky" ) end),

	awful.key({ modkey, "Control" }, "Delete", function () awful.util.spawn( "/home/msjche/.local/bin/lock" ) end),
...
--              {description = "show main menu", group = "awesome"}),
    ...
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end,	--Switch between monitors
...
--    awful.key({ altkey, }, "b", function () beautiful.show_battery+status() end),
...
--              {description = "show the menubar", group = "launcher"}),
	...
	awful.key({ modkey }, "a", function () os.execute(string.format("dmenu_run -i",
          beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
	{description = "show dmenu", group = "launcher"}),

	awful.key({ altkey }, "a", function () os.execute(string.format("dmenuunicode",
          beautiful.bg_normal, beautiful.fg_normal, beautiful.bg_focus, beautiful.fg_focus))
	end,
	{description = "show dmenu", group = "launcher"}),
...
--        {description = "show rofi", group = "launcher"}),
    ...
    awful.key({ modkey,           }, "c",      function (c) c.ontop = not c.ontop            end,
